...
var gameGenderRegex = /^[m|f|o]$/i; // m/M for Male, f/F for Female, a/A for Any/No preferance
var gameDescriptionRegex = /^[a-zA-Z0-9\'\-\:]*$/ // Alphanumerical with : - ' allowed
var gameLocationRegex = /^[a-zA-Z0-9\'\-\:]*$/ // Alphanumerical with : - ' allowed
var gameEnforcedParamRegex = /^[skill|age|gender]$/i; // Skill, age or gender can be enforced
