define({ "api": [
  ...
  },
  {
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "User",
            "description": "<p>'s extendedProfile entry (userId, skill_level, age, gender, location)</p>"
          }
        ]
      },
      "examples": [
    ...
    "groupTitle": "ExtendedProfile"
  },
  {
    "type": "put",
    "url": "/refresh",
    "title": "Update User's Extended Profile",
    "name": "updateExtendedUser",
    "group": "ExtendedProfile",
  ...
  },
  {
    ...
    "name": "Get_game",
    "group": "Games",
    "description": "<p>API used for getting the user of a game. Game id has to correspond to a game actually created.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "description": "<p>The minimum skill of the game (creator - offset)</p>"
          },
          {
            "group": "Parameter",
            "type": "int",
            ...
            "description": "<p>The maximum skill of the game (creator + offset)</p>"
          },
          {
            "group": "Parameter",
            "type": "int",
